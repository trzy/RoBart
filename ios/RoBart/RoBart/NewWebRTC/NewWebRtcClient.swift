...
actor NewWebRtcClient: ObservableObject {
    ...
    fileprivate enum Event {
        case timeoutCheck
        case serverConfigurationReceived(AsyncWebRtcClient.ServerConfiguration)
    ...
    func onServerConfigurationReceived(_ config: AsyncWebRtcClient.ServerConfiguration) async {
    ...
    private func createConnection(with serverConfig: AsyncWebRtcClient.ServerConfiguration) async throws -> RTCPeerConnection {
    ...
    private func createConnectionConfiguration(with serverConfig: AsyncWebRtcClient.ServerConfiguration) -> (RTCConfiguration, RTCMediaConstraints) {
...
extension NewWebRtcClient.RtcDelegateAdapter: RTCPeerConnectionDelegate {
...
extension NewWebRtcClient.RtcDelegateAdapter: RTCDataChannelDelegate {
...
extension NewWebRtcClient.InternalError: LocalizedError {
...
fileprivate func log(_ message: String) {
    print("[NewWebRtcClient] \(message)")
}

fileprivate func logError(_ message: String) {
    print("[NewWebRtcClient] Error: \(message)")
}
